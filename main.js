...
var _Jeff_Hostetler$wine_app$Main$displaySelected = function (selectedName) {
	return (!_elm_lang$core$Native_Utils.eq(selectedName, '')) ? A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('row featurette'),
			_1: {ctor: '[]'}
		},
		{
			ctor: '::',
					...
					_0: A2(
						...
						{ctor: '[]'},
						{
							...
							_0: _elm_lang$html$Html$text(
								A2(_elm_lang$core$Basics_ops['++'], 'You have selected ', selectedName)),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
...
var _Jeff_Hostetler$wine_app$Main$findPairings = F2(
	function (wineIds, id) {
		var matches = _elm_lang$core$List$length(
			A2(
				_elm_lang$core$List$filter,
				function (someId) {
					return _elm_lang$core$Native_Utils.eq(someId, id);
				},
				wineIds));
		return _elm_lang$core$Native_Utils.cmp(matches, 0) > 0;
	});
var _Jeff_Hostetler$wine_app$Main$Wine = F3(
	function (a, b, c) {
		return {id: a, wineType: b, name: c};
	});
var _Jeff_Hostetler$wine_app$Main$initialWines = {
	ctor: '::',
	_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 1, 'White', 'Chardonnay'),
	_1: {
		ctor: '::',
		_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 2, 'White', 'Reisling'),
		_1: {
			ctor: '::',
			_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 3, 'White', 'Chenin Blanc'),
			_1: {
				ctor: '::',
				_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 4, 'White', 'Pinot Gris'),
				_1: {
					ctor: '::',
					_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 5, 'White', 'Pinot Blanc'),
					_1: {
						ctor: '::',
						_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 6, 'White', 'Gruner Vetliner'),
						_1: {
							ctor: '::',
							_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 7, 'White', 'Semillon'),
							_1: {
								ctor: '::',
								_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 8, 'White', 'Bubbles'),
								_1: {
									ctor: '::',
									_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 9, 'Red', 'Cabernet'),
									_1: {
										ctor: '::',
										_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 10, 'Red', 'Cab Franc'),
										_1: {
											ctor: '::',
											_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 11, 'Red', 'Syrah'),
											_1: {
												ctor: '::',
												_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 12, 'Red', 'Merlot'),
												_1: {
													ctor: '::',
													_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 13, 'Red', 'Tempernillo'),
													_1: {
														ctor: '::',
														_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 14, 'Red', 'Malbec'),
														_1: {
															ctor: '::',
															_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 15, 'Red', 'Pinot Noir'),
															_1: {
																ctor: '::',
																_0: A3(_Jeff_Hostetler$wine_app$Main$Wine, 16, 'Red', 'Port'),
																_1: {ctor: '[]'}
															}
														}
													}
...
var _Jeff_Hostetler$wine_app$Main$Food = F3(
	function (a, b, c) {
		return {id: a, wineIds: b, name: c};
	});
var _Jeff_Hostetler$wine_app$Main$initialFoods = {
	ctor: '::',
	_0: A3(
		_Jeff_Hostetler$wine_app$Main$Food,
		1,
		{
			ctor: '::',
			_0: 10,
...
var _Jeff_Hostetler$wine_app$Main$initialModel = {wines: _Jeff_Hostetler$wine_app$Main$initialWines, foods: _Jeff_Hostetler$wine_app$Main$initialFoods, selected: ''};
var _Jeff_Hostetler$wine_app$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChooseWine':
				...
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						foods: A2(
							_elm_lang$core$List$filter,
							function (f) {
								return A2(_Jeff_Hostetler$wine_app$Main$findPairings, f.wineIds, _p1.id);
							},
							_Jeff_Hostetler$wine_app$Main$initialFoods),
						selected: _p1.name
					});
			case 'ChooseFood':
				var _p2 = _p0._0;
				return _elm_lang$core$Native_Utils.update(
					model,
					{
						wines: A2(
							_elm_lang$core$List$filter,
							function (w) {
								return A2(_Jeff_Hostetler$wine_app$Main$findPairings, _p2.wineIds, w.id);
							},
							_Jeff_Hostetler$wine_app$Main$initialWines),
						selected: _p2.name
					});
			case 'SearchWines':
				return _elm_lang$core$Native_Utils.update(
						...
						wines: A2(
							...
							function (w) {
								return A2(
									...
									_elm_lang$core$String$toLower(w.name));
							},
							_Jeff_Hostetler$wine_app$Main$initialWines)
					});
			case 'SearchFoods':
			...
			default:
				return _Jeff_Hostetler$wine_app$Main$initialModel;
		}
	});
var _Jeff_Hostetler$wine_app$Main$Model = F3(
	function (a, b, c) {
		return {wines: a, foods: b, selected: c};
	});
var _Jeff_Hostetler$wine_app$Main$ResetModel = {ctor: 'ResetModel'};
var _Jeff_Hostetler$wine_app$Main$SearchFoods = function (a) {
	return {ctor: 'SearchFoods', _0: a};
};
var _Jeff_Hostetler$wine_app$Main$SearchWines = function (a) {
	return {ctor: 'SearchWines', _0: a};
};
var _Jeff_Hostetler$wine_app$Main$ChooseFood = function (a) {
	return {ctor: 'ChooseFood', _0: a};
};
var _Jeff_Hostetler$wine_app$Main$displayFood = function (food) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			_0: _elm_lang$html$Html_Attributes$class('col-md-3 hoverable'),
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_Jeff_Hostetler$wine_app$Main$ChooseFood(food)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _Jeff_Hostetler$wine_app$Main$displayFoods = function (foods) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Filter by Food'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Click on a food item or search and then select desired food'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Food Item'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_Jeff_Hostetler$wine_app$Main$SearchFoods),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
						...
						_0: A2(
							...
							},
							{
								...
								_0: A2(
									...
									A2(_elm_lang$core$List$map, _Jeff_Hostetler$wine_app$Main$displayFood, foods)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
...
var _Jeff_Hostetler$wine_app$Main$ChooseWine = function (a) {
	return {ctor: 'ChooseWine', _0: a};
};
var _Jeff_Hostetler$wine_app$Main$displayWine = function (wine) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
			...
			_1: {
				ctor: '::',
				_0: _elm_lang$html$Html_Events$onClick(
					_Jeff_Hostetler$wine_app$Main$ChooseWine(wine)),
				_1: {ctor: '[]'}
			}
		},
		{
...
var _Jeff_Hostetler$wine_app$Main$displayWineCategory = F2(
	function (title, wines) {
		return (_elm_lang$core$Native_Utils.cmp(
			_elm_lang$core$List$length(wines),
			0) > 0) ? A2(
			_elm_lang$html$Html$div,
			{
				ctor: '::',
			...
			},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(_elm_lang$core$List$map, _Jeff_Hostetler$wine_app$Main$displayWine, wines)),
					_1: {ctor: '[]'}
				}
			}) : A2(
			_elm_lang$html$Html$div,
...
var _Jeff_Hostetler$wine_app$Main$displayWines = function (wines) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Filter by Wine'),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$html$Html$text('Click on a wine type or search and then select desired wine'),
										_1: {ctor: '[]'}
									}),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$placeholder('Wine Type'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onInput(_Jeff_Hostetler$wine_app$Main$SearchWines),
												_1: {ctor: '[]'}
											}
										},
										{ctor: '[]'}),
					...
					_1: {
						ctor: '::',
						_0: A2(
							_Jeff_Hostetler$wine_app$Main$displayWineCategory,
							'White',
							A2(
								_elm_lang$core$List$filter,
								function (n) {
									return _elm_lang$core$Native_Utils.eq(n.wineType, 'White');
								},
								wines)),
						_1: {
							ctor: '::',
							_0: A2(
								...
								A2(
									_elm_lang$core$List$filter,
									function (n) {
										return _elm_lang$core$Native_Utils.eq(n.wineType, 'Red');
									},
									wines)),
							_1: {ctor: '[]'}
						}
...
var _Jeff_Hostetler$wine_app$Main$view = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text('Pairing Lab'),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}),
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('container container-sup'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: A2(
							...
							{
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$class('top-border'),
								_1: {ctor: '[]'}
							},
							{ctor: '[]'}),
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _Jeff_Hostetler$wine_app$Main$displaySelected(model.selected),
								_1: {
									ctor: '::',
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$class('hot'),
											_1: {ctor: '[]'}
										},
										{ctor: '[]'}),
									_1: {
										ctor: '::',
										_0: _Jeff_Hostetler$wine_app$Main$displayWines(model.wines),
										_1: {
											ctor: '::',
											_0: A2(
												_elm_lang$html$Html$hr,
											...
											_1: {
												ctor: '::',
												_0: _Jeff_Hostetler$wine_app$Main$displayFoods(model.foods),
												_1: {
													ctor: '::',
													_0: A2(
														_elm_lang$html$Html$hr,
													...
													_1: {
														...
														_0: A2(
															_elm_lang$html$Html$button,
															{
																...
																_1: {
																	ctor: '::',
																	_0: _elm_lang$html$Html_Events$onClick(_Jeff_Hostetler$wine_app$Main$ResetModel),
																	_1: {ctor: '[]'}
																}
															},
															{
...
var _Jeff_Hostetler$wine_app$Main$main = _elm_lang$html$Html$beginnerProgram(
	{model: _Jeff_Hostetler$wine_app$Main$initialModel, view: _Jeff_Hostetler$wine_app$Main$view, update: _Jeff_Hostetler$wine_app$Main$update})();

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _Jeff_Hostetler$wine_app$Main$main !== 'undefined') {
    _Jeff_Hostetler$wine_app$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"SearchWines":["String"],"ChooseFood":["Main.Food"],"SearchFoods":["String"],"ResetModel":[],"ChooseWine":["Main.Wine"]}}},"aliases":{"Main.Food":{"args":[],"type":"{ id : Int, wineIds : List Int, name : String }"},"Main.Wine":{"args":[],"type":"{ id : Int, wineType : String, name : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
